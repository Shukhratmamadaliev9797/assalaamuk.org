...
export default function EditNews(props) {
  ...
  useEffect(() => {
    if (props.news) {
      setNewsID(props.news._id);
      setTitle(props.news.title);
      setImage(props.news.image);
      setSubtitle1(props.news.subtitle1);
      setParagraph1(props.news.paragraph1);
      setImage1(props.news.setImage1);
      setSubtitle2(props.news.subtitle2);
      setParagraph2(props.news.setParagraph2);
      setImage2(props.news.setImage2);
      setSubtitle3(props.news.subtitle3);
      setParagraph3(props.news.setParagraph3);
      setImage3(props.news.setImage3);
      setSubtitle3(props.news.subtitle3);
      setParagraph3(props.news.setParagraph3);
      setImage3(props.news.setImage3);
    }
